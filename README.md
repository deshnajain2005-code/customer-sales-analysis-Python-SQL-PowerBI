...
Imported cleaned data into SQL for structured querying
Ran queries to analyze:

Customer segmentation by category, age group, and region
...
Key KPIs (Total Sales, Customer Count, Avg. Purchase Value)
...
Loyal/repeat customers show stronger average order values compared to new customers — a loyalty rewards program could be beneficial
